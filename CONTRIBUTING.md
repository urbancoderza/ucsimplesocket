...
If you have questions about how to use UCSimpleSocket, please read the
[UCSimpleSocket documentation][documentation] or ask on [Stack Overflow][stackoverflow].
...
- Stability is important. UCSimpleSocket is used by thousands of other libraries and features that require
...
- Check that new and updated code follows UCSimpleSocket's existing code formatting and naming standard
- Run UCSimpleSocket's unit tests to ensure no existing functionality has been affected
...
By contributing your code to UCSimpleSocket you grant Andre Trollip a non-exclusive, irrevocable, worldwide,
...
[documentation]: https://github.com/urbancoderza/ucsimplesocket/tree/master/UCSimpleSocket/Documentation
